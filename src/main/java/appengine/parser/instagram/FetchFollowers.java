    ...
    private void makeRequest(String pageName, String currentUserName, String lastCursor) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("https://www.instagram.com/graphql/query/?query_hash=37479f2b8209594dde7facb0d904896a&variables=%7B%22id%22%3A%221088465889%22%2C%22first%22%3A12%2C%22after%22%3A%22"+lastCursor+"%22%7D")
                    .get()
                    .addHeader("accept", "*/*")
