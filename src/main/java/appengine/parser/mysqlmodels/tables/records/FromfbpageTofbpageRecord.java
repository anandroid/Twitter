...
public class FromfbpageTofbpageRecord extends TableRecordImpl<FromfbpageTofbpageRecord> implements Record3<String, String, Timestamp> {

    private static final long serialVersionUID = -2078341071;
